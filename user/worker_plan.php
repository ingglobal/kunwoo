...
<div id="pdf_box">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            <th scope="col">
                <a href="<?=G5_USER_URL?>/worker_plan.php?start_date=<?=$prev_week_date?>" class="prev_week"><span class="sound_only">이전주</span><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                설비명
            </th>
            <th scope="col">주/야</th>
            <?php
            ...
            <th scope="col" class="<?=(($dr_v['date']==G5_TIME_YMD)?'th_today':'')?>">
                <?=$dr_v['day']?>
                <?php if($d_num == $num){ ?>
                <a href="<?=G5_USER_URL?>/worker_plan.php?start_date=<?=$next_week_date?>" class="next_week"><span class="sound_only">다음주</span><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <?php } ?>
            </th>
            <?php
            $num++;
