...
if ($w == 'c') // 댓글 입력
{
    ...
    */
    ...
    if ($config['cf_email_use'] && $board['bo_use_email'])
    {
        ...
        $link_url = G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.'&amp;'.$qstr.'&amp;#c_'.$comment_id;
...
$redirect_url = short_url_clean(G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr['wr_parent'].'&amp;'.$qstr.'&amp;#c_'.$comment_id);
