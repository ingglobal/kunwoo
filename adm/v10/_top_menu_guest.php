...
<h2 id="container_sub_title">
	<a href="./material_list.php" class="btn_top_menu '.$active_guest_item_list.'">재고데이터</a>
	<a href="./material_groupby_list.php" class="btn_top_menu '.$active_guest_item_row_list.'">재고품목별조회</a>
	'.$sub_title_term_list.'
</h2>
';
?>
