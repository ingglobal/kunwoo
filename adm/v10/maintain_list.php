...
<div class="new_win">
    ...
    <div class=" new_win_con">
        ...
        //                print_r2($v1);
                        ...
                        else if($k1=='mnt_subject') {
                            $row['class'][$k1] = ' td_left';
                        }

                        $row['colspan'] = ($v1[1]>1) ? ' colspan="'.$v1[1].'"' : '';   // colspan 설정
                        $row['rowspan'] = ($v1[2]>1) ? ' rowspan="'.$v1[2].'"' : '';   // rowspan 설정
                        echo '<td class="td_'.$k1.' '.$row['class'][$k1].'" '.$row['colspan'].' '.$row['rowspan'].'>'.$row[$k1].'</td>';
                    }
                }
