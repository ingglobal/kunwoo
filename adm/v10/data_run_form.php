...
$items1 = array(
    ...
    ,"dta_value"=>array("값","required",0,0,'초단위(1분당 몇 초), 생산량인 경우는 생산카운터를 입력','')
    ,"dta_dt"=>array("일시","required",100,0,'일시는 timestamp값입니다.','',2)
    ,"dta_mmi_no"=>array("기종번호","",70,0,'','',0)
    ,"dta_status"=>array("상태","required",60,'','0=정상, 1=비정상','',0)
);
?>
