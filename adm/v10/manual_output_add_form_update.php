...
$table_name = 'g5_1_data_output_'.$mms_idx;
$arr['dta_defect'] = 1;
$arr['mms_idx'] = $mms_idx;
...
// 공통요소
$sql_common = " dta_shf_no = '".$shift_no."'
                , dta_mmi_no = '".$item_no."'
...
$itme_dom = $mms_idx."^".$shift_no."^".$item_no;
?>
<script>
