...
<h2 id="container_sub_title">
	<a href="./material_row_list.php" class="btn_top_menu '.$active_material_row_list.'">자재재고(번들번호)</a>
	<a href="./material_list.php" class="btn_top_menu '.$active_material_list.'">자재재고(히트넘버)</a>
	'.$sub_title_term_list.'
</h2>
';
?>
