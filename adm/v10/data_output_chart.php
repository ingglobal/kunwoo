...
$(document).on('click','#fsearch button[type=submit]',function(e){
    ...
    var dta_url = '//kunwoo.epcs.co.kr/device/json/output'+dta_file+'.php?token=1099de5drf09&mms_idx='+mms_idx+'&shf_no='+shf_no+'&dta_type='+dta_type+'&dta_no='+dta_no+'&dta_item='+dta_item+'&dta_unit='+dta_unit+'&st_date='+st_date+'&st_time='+st_time+'&en_date='+en_date+'&en_time='+en_time;
    // console.log(dta_url);
