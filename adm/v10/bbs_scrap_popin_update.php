...
if (!$is_member)
{
    $href = './login.php?'.$qstr.'&amp;url='.urlencode(G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id);
...
if ($row['cnt'])
{
    ...
    <a href="'.G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.'">돌아가기</a>
    </noscript>';
    exit;
}
