...
add_stylesheet('<link rel="stylesheet" href="'.$u_skin_url.'/style.css">', 1);
?>
<style>
</style>
...
<div id="bo_list">
    ...
    <div class="list_01">
        ...
        <ul>
            ...
            <?php } ?>
            <?php if (count($list) == 0) { echo '<li class="empty_table">고객이 없습니다.</li>'; } ?>
        </ul>
    </div>
</div>
...
<div class="div_fixed_top">
    ...
    <ul>
        <li><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="btn001"><i class="fa fa-trash-o" aria-hidden="true"></i></button></li>
        <li><button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn001"><i class="fa fa-files-o" aria-hidden="true"></i></button></li>
        <li><a href="./member_form.php" class="btn001"><i class="fa fa-plus"></i> 업체</a></li>
        <li><a href="./member_form.php" class="btn001"><i class="fa fa-plus"></i> 고객</a></li>
    </ul>
    <?php } ?>
</div>
