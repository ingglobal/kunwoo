...
<aside id="ol_after">
    ...
    <div id="ol_after_hd" class="ol">
        ...
        <a href="javascript:" target="_blank" class="point">환영합니다.
        </a>
        <div id="ol_after_btn">
            <?php if ($is_admin == 'super' || $is_auth) { ?><a href="<?php echo G5_ADMIN_URL ?>/v10" class="btn_admin" style="display:none;">관리자</a><?php } ?>
            <a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout">로그아웃</a>
        </div>
        <button type="button" class="menu_close"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only">카테고리닫기</span></button>
    </div>

    <ul id="ol_after_private" style="display:none;">
        <li id="ol_after_memo">
