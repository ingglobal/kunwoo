...
<header id="hd">
    ...
    <div id="hd_wr">
        ...
        <div id="hd_btn">
            <button type="button" id="btn_hdcate" style="display:none;"><i class="fa fa-bars"></i><span class="sound_only">분류</span></button>
            <?php if(!$member['mb_id']) { ?>
            <button type="button" id="btn_hdsch" onClick="javascript:self.location='<?=G5_BBS_URL?>/login.php'"><i class="fa fa-user-circle"></i><span class="sound_only">로그인</span></button>
            <?php } else { ?>
