...
?>
<link rel="shortcut icon" href="<?=G5_URL?>/favicon.ico" type="image/x-ico" />
...
add_javascript('<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>', 0);
