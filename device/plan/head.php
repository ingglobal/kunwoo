...
<link rel="stylesheet" href="<?=G5_DEVICE_URL?>/plan/css/default.css">
<link rel="stylesheet" href="<?=G5_DEVICE_URL?>/plan/css/spot_plan.css">
<?php if(is_file(G5_USER_ADMIN_MODAL_PATH.'/css/default_modal.css')) { ?>
<link rel="stylesheet" href="<?=G5_USER_ADMIN_MODAL_URL?>/css/default_modal.css">
<?php } ?>
<?php if(is_file(G5_USER_ADMIN_MODAL_PATH.'/css/'.$g5['file_name'].'_modal.css')) { ?>
<link rel="stylesheet" href="<?=G5_USER_ADMIN_MODAL_URL?>/css/<?=$g5['file_name']?>_modal.css">
<?php } ?>
