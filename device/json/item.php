...
//	$list = array('');
    ...
    if(isset($_REQUEST['dta_defect'])) {
        $dta_defects = $g5['set_itm_status_ok_array'];
    }
    else {
        $dta_defects = array_merge($g5['set_itm_status_ok_array'],$g5['set_itm_status_ng_array']);
    }
    ...
    $where[] = " itm_status IN (".implode(",",$dta_defects).") ";   // 디폴트 검색조건
    ...
    if(!$en_date) {
        ...
        // echo $sql.'<br>';
        // print_r2($en1);
        $en1['dta_dt'] = strtotime($en1['itm_reg_dt']);
