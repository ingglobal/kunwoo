...
//	$result_arr = array("code"=>400,"message"=>"not json type");
...
if(is_array($_REQUEST['com_idx'])) {
    ...
    for($i=0;$i<sizeof($_REQUEST['imp_idx']);$i++) {
        ...
        $sql_common[$i] = " com_idx = '".$_REQUEST['com_idx'][$i]."'
                        ...
                        , mms_idx = '".$_REQUEST['mms_idx'][$i]."'
                        , cod_code = '".$_REQUEST['cod_code'][$i]."'
                        , cod_group = '".$_REQUEST['cod_group'][$i]."'
                        , cod_type = '".$_REQUEST['cod_type'][$i]."'
                        , cod_interval = '".$_REQUEST['cod_interval'][$i]."'
                        , cod_count = '".$_REQUEST['cod_count'][$i]."'
                        , cod_condition = '".$_REQUEST['cod_condition'][$i]."'
