...
$sql = " SELECT *
            ...
            , ( SELECT COUNT(plt_idx) FROM {$g5['pallet_table']} WHERE oop_idx = oop.oop_idx AND plt_type = 'forge' AND plt_status NOT IN('delete','del','trash','cancel') ) AS plt_f
            , ( SELECT COUNT(plt_idx) FROM {$g5['pallet_table']} WHERE oop_idx = oop.oop_idx AND plt_type = 'product' AND plt_status NOT IN('delete','del','trash','cancel') ) AS plt_c
